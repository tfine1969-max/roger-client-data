            ...
            <tfoot>
               <tr className="bg-muted/30 border-t-2 font-semibold">
                 <td className="px-2 py-2 text-xs uppercase tracking-wider" colSpan={7}>Total</td>
                  <td className="px-2 py-2 font-numbers text-right text-xs text-chart-2">
                    {fmtNum(rows.reduce((s, r) => s + (r.rebate_fee_monthly_amount_zar ?? 0), 0))}
                  </td>
                  <td className="px-2 py-2 font-numbers text-right text-xs text-chart-1">
                    {fmtNum(rows.reduce((s, r) => s + (r.advisory_fee_monthly_amount_zar ?? 0), 0))}
                  </td>
                  <td className="px-2 py-2 font-numbers text-right text-xs font-bold">
