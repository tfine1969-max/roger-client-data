...
export default function ProposalEngine() {
  ...
  useEffect(() => {
    ...
    setLocalData({
      ...
      annual_income_band: proposal.annual_income_band || client.annual_income_band || client.gross_annual_income_band || client.trust_income_band || client.gross_annual_turnover || '',
      net_worth_band: proposal.net_worth_band || client.net_worth_band || client.trust_asset_value_band || client.total_assets_band || '',
      liquidity_requirement: proposal.liquidity_requirement || client.liquidity_requirement || client.liquidity_needs || '',
      total_liabilities: proposal.total_liabilities || client.total_liabilities || client.entity_total_liabilities || '',
      tax_residency: proposal.tax_residency || client.tax_residency || client.entity_tax_residency || '',
      source_of_funds: proposal.source_of_funds?.length > 0
        ? proposal.source_of_funds
        : (client.source_of_funds || client.trust_source_of_funds || client.entity_source_of_funds || []),
      source_of_funds_notes: proposal.source_of_funds_notes || client.beneficiary_declaration || client.ubo_declaration || '',
      trustees_list: proposal.trustees_list || client.trustees_list || [],
      directors_list: proposal.directors_list || client.directors_list || [],
      trust_number: proposal.trust_number || client.trust_number || '',
      registration_number: proposal.registration_number || client.registration_number || '',
      ...
      advisor_review_required: proposal.advisor_review_required ?? client.advisor_review_required,
  ...
  const handleGeneratePdf = async () => {
    ...
    const ficaSnapshot = {
      ...
      advisor_review_required: localData.advisor_review_required ?? false,
