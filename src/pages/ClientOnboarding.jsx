...
import IncomeAssetsStep from '@/components/onboarding/IncomeAssetsStep';
...
export default function ClientOnboarding() {
  ...
  const uploadLoaPdfAndRecord = async ({ blob, source, signatureMethod }) => {
    ...
    const updateData = {
      ...
      loa_completion_method: source === 'Electronic Signature' ? 'electronic' : 'manual',
    ...
    <div className="h-screen bg-background flex overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5 max-w-6xl mx-auto w-full">
          ...
          {currentStep === 5 && <IncomeAssetsStep formData={formData} handleChange={handleChange} />}
